...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_redux_store__ = __webpack_require__("../../../../@angular-redux/store/lib/src/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__store_store__ = __webpack_require__("../../../../../src/app/store/store.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__angular_redux_router__ = __webpack_require__("../../../../@angular-redux/router/lib/es5/src/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__angular_redux_router___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__angular_redux_router__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_profile_profile_action__ = __webpack_require__("../../../../../src/app/components/profile/profile.action.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_redux_observable__ = __webpack_require__("../../../../redux-observable/lib/esm/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_redux_logger__ = __webpack_require__("../../../../redux-logger/dist/redux-logger.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_redux_logger___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_redux_logger__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_profile_profile_component__ = __webpack_require__("../../../../../src/app/components/profile/profile.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_sidenav_sidenav_component__ = __webpack_require__("../../../../../src/app/components/sidenav/sidenav.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__users_epic__ = __webpack_require__("../../../../../src/app/users.epic.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_users_list_users_list_component__ = __webpack_require__("../../../../../src/app/components/users-list/users-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__components_users_list_users_list_action__ = __webpack_require__("../../../../../src/app/components/users-list/users-list.action.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33_angular5_social_login__ = __webpack_require__("../../../../angular5-social-login/angular5-social-login.umd.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33_angular5_social_login___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_33_angular5_social_login__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__components_chatroom_chatroom_component__ = __webpack_require__("../../../../../src/app/components/chatroom/chatroom.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__services_chat_service__ = __webpack_require__("../../../../../src/app/services/chat.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__services_websocket_service__ = __webpack_require__("../../../../../src/app/services/websocket.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__components_userdetails_userdetails_component__ = __webpack_require__("../../../../../src/app/components/userdetails/userdetails.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__components_stats_stats_component__ = __webpack_require__("../../../../../src/app/components/stats/stats.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__components_projects_projects_component__ = __webpack_require__("../../../../../src/app/components/projects/projects.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__components_detailedinformation_detailedinformation_component__ = __webpack_require__("../../../../../src/app/components/detailedinformation/detailedinformation.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__filterusers_pipe__ = __webpack_require__("../../../../../src/app/filterusers.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__services_PasswordValidator__ = __webpack_require__("../../../../../src/app/services/PasswordValidator.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__services_navbar_service__ = __webpack_require__("../../../../../src/app/services/navbar.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    function AppModule(ngRedux, devTool, ngReduxRouter, usersEpic) {
        ...
        var rootEpic = Object(__WEBPACK_IMPORTED_MODULE_12_redux_observable__["a" /* combineEpics */])(this.usersEpic.getUser, this.usersEpic.updateUser, this.usersEpic.getAllUsers, this.usersEpic.deleteUser
        // Each epic is referenced here.
        );
        var middleware = [
            Object(__WEBPACK_IMPORTED_MODULE_12_redux_observable__["b" /* createEpicMiddleware */])(rootEpic), Object(__WEBPACK_IMPORTED_MODULE_13_redux_logger__["createLogger"])({ level: 'info', collapsed: true })
        ];
        this.ngRedux.configureStore(__WEBPACK_IMPORTED_MODULE_9__store_store__["a" /* rootReducer */], {}, middleware, [devTool.isEnabled() ? devTool.enhancer() : function (f) { return f; }]);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__components_profile_profile_component__["a" /* ProfileComponent */],
                __WEBPACK_IMPORTED_MODULE_25__components_footer_footer_component__["a" /* FooterComponent */],
                __WEBPACK_IMPORTED_MODULE_29__components_sidenav_sidenav_component__["a" /* SidenavComponent */],
                __WEBPACK_IMPORTED_MODULE_31__components_users_list_users_list_component__["a" /* UsersListComponent */],
                __WEBPACK_IMPORTED_MODULE_34__components_chatroom_chatroom_component__["a" /* ChatroomComponent */],
                __WEBPACK_IMPORTED_MODULE_37__components_userdetails_userdetails_component__["a" /* UserdetailsComponent */],
                __WEBPACK_IMPORTED_MODULE_38__components_stats_stats_component__["a" /* StatsComponent */],
                __WEBPACK_IMPORTED_MODULE_39__components_projects_projects_component__["a" /* ProjectsComponent */],
                __WEBPACK_IMPORTED_MODULE_40__components_detailedinformation_detailedinformation_component__["a" /* DetailedinformationComponent */],
                __WEBPACK_IMPORTED_MODULE_41__filterusers_pipe__["a" /* FilterusersPipe */],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__angular_redux_router__["NgReduxRouterModule"].forRoot(),
                __WEBPACK_IMPORTED_MODULE_33_angular5_social_login__["SocialLoginModule"]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_26__services_auth_service__["a" /* myAuthService */],
                __WEBPACK_IMPORTED_MODULE_43__services_navbar_service__["a" /* NavbarService */],
                __WEBPACK_IMPORTED_MODULE_28__guards_auth_guard__["a" /* AuthGuard */],
                __WEBPACK_IMPORTED_MODULE_11__components_profile_profile_action__["a" /* UserActions */],
                __WEBPACK_IMPORTED_MODULE_32__components_users_list_users_list_action__["a" /* UsersActions */],
                __WEBPACK_IMPORTED_MODULE_30__users_epic__["a" /* UsersEpic */],
                __WEBPACK_IMPORTED_MODULE_42__services_PasswordValidator__["a" /* PasswordValidator */],
                {
                    provide: __WEBPACK_IMPORTED_MODULE_33_angular5_social_login__["AuthServiceConfig"],
                    useFactory: getAuthServiceConfigs
                },
                __WEBPACK_IMPORTED_MODULE_35__services_chat_service__["a" /* ChatService */],
                __WEBPACK_IMPORTED_MODULE_36__services_websocket_service__["a" /* WebsocketService */]
            ],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_18__app_component__["a" /* AppComponent */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__angular_redux_store__["NgRedux"],
            __WEBPACK_IMPORTED_MODULE_8__angular_redux_store__["DevToolsExtension"],
            __WEBPACK_IMPORTED_MODULE_10__angular_redux_router__["NgReduxRouter"],
            __WEBPACK_IMPORTED_MODULE_30__users_epic__["a" /* UsersEpic */]])
    ], AppModule);
    return AppModule;
}());
...
function getAuthServiceConfigs() {
    var config = new __WEBPACK_IMPORTED_MODULE_33_angular5_social_login__["AuthServiceConfig"]([
        ...
        },
        {
            ...
            provider: new __WEBPACK_IMPORTED_MODULE_33_angular5_social_login__["GoogleLoginProvider"]("519676817251-00tmt8ii5s68ll9pgtojc7rcebtbu66e.apps.googleusercontent.com")
        },
    ]);
    return config;
}
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onSubmit = function (registerForm) {
        ...
        if (registerForm.valid) {
            ...
            this.authService.registerUser(registerForm).subscribe(function (data) {
                if (data.success) {
...
var UsersEpic = /** @class */ (function () {
    function UsersEpic(authService) {
        ...
        this.getAllUsers = function (action$) {
            return action$.ofType(__WEBPACK_IMPORTED_MODULE_4__components_users_list_users_list_action__["a" /* UsersActions */].GET_USERS) // Listen for this action
        ...
        this.deleteUser = function (action$) {
            return action$.ofType(__WEBPACK_IMPORTED_MODULE_4__components_users_list_users_list_action__["a" /* UsersActions */].DELETE_USER) // Listen for this action
                .mergeMap(function (_a) {
                var payload = _a.payload;
